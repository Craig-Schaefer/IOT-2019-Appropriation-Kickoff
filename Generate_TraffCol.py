...
metric = "TrafficCollisions"
metricmoniker = "TrfCol"
metricpath = "C:\\IOT2\\IOT2_KickoffData.gdb\\TrafficCollisions"
mxdpath = r"C:\IOT2\Kickoff\Appr_TrafCol.mxd"
...
# Test array Bridges
#trafCol_Array = ['2037B0167Z', '2037B0173Z']

# Production array Bridges
trafCol_Array = ['2037B0167Z', '2037B0173Z', '2037B0179Z', '2037B0183Z', '2037B0204Z', '2037B0232Z', '2037B0236Z', '2037B0241Z', '2037B0261A', '2037B0263Z', '2037B0269Z', '2037B0271Z', '2037B0286Z', '2037B0315Z', '2037B0322Z', '2037B0329Z', '2037B0336Z', '2037B0343Z', '2037B0404Z', '2037B0474Z', '2037B0478Z', '2037B0482Z']
...
for trafCol_Num in trafCol_Array:
	...
	try:
		...
		arcpy.MakeFeatureLayer_management(Collisions_TPD__3_, TrfCol_2036A0001Z, "", "", "OBJECTID OBJECTID VISIBLE NONE;Collision_Date Collision_Date VISIBLE NONE;Day_ Day_ VISIBLE NONE;Hour_ Hour_ VISIBLE NONE;Time_ Time_ VISIBLE NONE;Incident_Number Incident_Number VISIBLE NONE;Ucc_Code Ucc_Code VISIBLE NONE;Collision_Type Collision_Type VISIBLE NONE;Cause Cause VISIBLE NONE;Hit_and_Run Hit_and_Run VISIBLE NONE;Injury_Severity_Number Injury_Severity_Number VISIBLE NONE;Injury_Severity_Description Injury_Severity_Description VISIBLE NONE;Pedestrian Pedestrian VISIBLE NONE;Road_Conditions Road_Conditions VISIBLE NONE;Seat_Belt Seat_Belt VISIBLE NONE;Weather_Conditions Weather_Conditions VISIBLE NONE;Division Division VISIBLE NONE;Squad Squad VISIBLE NONE;Beat Beat VISIBLE NONE;GeoCode GeoCode VISIBLE NONE;Address Address VISIBLE NONE;Mappable Mappable VISIBLE NONE;Longitude Longitude VISIBLE NONE;Latitude Latitude VISIBLE NONE;Agency Agency VISIBLE NONE;Shape Shape VISIBLE NONE")
	...
	# for indexPage in ddp.selectedPages:
	  ...
	  # pageGRID = mxd.dataDrivenPages.pageRow.PageName
...
for trafCol_Num in trafCol_Array:
	...
	try:
		...
		arcpy.MakeFeatureLayer_management(Collisions_TPD, TrfCol_2036A0001Z__3_, "", "", "OBJECTID OBJECTID VISIBLE NONE;Collision_Date Collision_Date VISIBLE NONE;Day_ Day_ VISIBLE NONE;Hour_ Hour_ VISIBLE NONE;Time_ Time_ VISIBLE NONE;Incident_Number Incident_Number VISIBLE NONE;Ucc_Code Ucc_Code VISIBLE NONE;Collision_Type Collision_Type VISIBLE NONE;Cause Cause VISIBLE NONE;Hit_and_Run Hit_and_Run VISIBLE NONE;Injury_Severity_Number Injury_Severity_Number VISIBLE NONE;Injury_Severity_Description Injury_Severity_Description VISIBLE NONE;Pedestrian Pedestrian VISIBLE NONE;Road_Conditions Road_Conditions VISIBLE NONE;Seat_Belt Seat_Belt VISIBLE NONE;Weather_Conditions Weather_Conditions VISIBLE NONE;Division Division VISIBLE NONE;Squad Squad VISIBLE NONE;Beat Beat VISIBLE NONE;GeoCode GeoCode VISIBLE NONE;Address Address VISIBLE NONE;Mappable Mappable VISIBLE NONE;Longitude Longitude VISIBLE NONE;Latitude Latitude VISIBLE NONE;Agency Agency VISIBLE NONE;Shape Shape VISIBLE NONE")
...
del mxdpath
mxdpath = r"C:\IOT2\Kickoff\Appr_TrafCol_NonArt.mxd"

# Test array NonArt
#trafCol_Array = ['2036N1068Z', '2036N4029Z']
...
for trafCol_Num in trafCol_Array:
	...
	try:
		...
		arcpy.MakeFeatureLayer_management(Collisions_TPD__2_, TrfCol_2036A0001Z__2_, "", "", "OBJECTID OBJECTID VISIBLE NONE;Collision_Date Collision_Date VISIBLE NONE;Day_ Day_ VISIBLE NONE;Hour_ Hour_ VISIBLE NONE;Time_ Time_ VISIBLE NONE;Incident_Number Incident_Number VISIBLE NONE;Ucc_Code Ucc_Code VISIBLE NONE;Collision_Type Collision_Type VISIBLE NONE;Cause Cause VISIBLE NONE;Hit_and_Run Hit_and_Run VISIBLE NONE;Injury_Severity_Number Injury_Severity_Number VISIBLE NONE;Injury_Severity_Description Injury_Severity_Description VISIBLE NONE;Pedestrian Pedestrian VISIBLE NONE;Road_Conditions Road_Conditions VISIBLE NONE;Seat_Belt Seat_Belt VISIBLE NONE;Weather_Conditions Weather_Conditions VISIBLE NONE;Division Division VISIBLE NONE;Squad Squad VISIBLE NONE;Beat Beat VISIBLE NONE;GeoCode GeoCode VISIBLE NONE;Address Address VISIBLE NONE;Mappable Mappable VISIBLE NONE;Longitude Longitude VISIBLE NONE;Latitude Latitude VISIBLE NONE;Agency Agency VISIBLE NONE;Shape Shape VISIBLE NONE")
